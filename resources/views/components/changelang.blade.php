<div x-data="{isOpen:false}">
    <button @click="isOpen = !isOpen" class="relative flex border-none bg-dark-fff">
        ...
        class="absolute -ml-16 rounded-lg mt-9">
            <li class="p-2 mt-2">
                <a href="{{ route('change-lang','en') }}" class="w-32 p-2 px-20 border rounded-lg cursor-pointer hover:bg-brand-secondary hover:text-dark-fff text-dark-100">English</a>
            </li>
            <li class="p-2 mt-2">
