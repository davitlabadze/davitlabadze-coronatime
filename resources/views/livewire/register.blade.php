        ...
        <div class="ml-108 sm:ml-16 w-full ">
            <form action="#">
                ...
                <div class="mt-30 sm:mt-43">
                    ...
                    <p class="text-dark-60 font-normal mt-16 sm:mt-8">Please enter required info to sign up</p>
                    <div class="mt-24">
                    ...
                    <div class="mt-24">
                        <label for="password1" class="text-dark-100 text-xxs font-bold block">Password</label>
                        <input class="mt-8 w-392 h-56 p-24 border border-inner-border rounded sm:w-343" type="password" placeholder="Repeat password" />
                    </div>
                    ...
                    <button type="submit" class="bg-brand-secondary w-392 h-56 rounded-lg mt-26 sm:w-343"><p class="text-dark-fff font-black">SIGN UP</p></button>
                    <div class="flex items-center justify-center mt-24 w-96 sm: -ml-20">
                        <p class="text-dark-60 font-normal">Don't have and account?</p>
                        <a href="{{ route('login') }}" class="text-dark-100 font-bold">Log in</a>
                    </div>
                </div>
            </form>
        </div>
